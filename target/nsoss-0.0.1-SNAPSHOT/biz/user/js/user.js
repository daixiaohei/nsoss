...
define('biz/user/js/user',function(require,exports,module){
	...
	var columns = [
        ...
        {title : '状态',dataIndex :'status', width:'10%',elCls:'center'}
    ];
    ...
    var Operation = {
    	Condition: {name:''},
    	data: {id:null,name:null,intro:null,email:null},
    	add: function(){//增
	    ...
	    edit: function(){//改
	        ...
	        $("#intro").val(selections[0].intro).change();
	        $("#email").val(selections[0].email).change();
