...
define('util/j_jquery',function(require,exports,module){
	...
	$.extend(J, {
		...
		FireEvent:function(eventMap){for(var i in eventMap){var ids = i.split(" ")[0];var eventName = i.split(" ")[1];(function(k){$(document).on(eventName,ids,function(){eventMap[k].call(this);});})(i);}},
